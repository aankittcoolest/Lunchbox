...
require INC_ROOT . '/app/routes/user/reserve.php';
require INC_ROOT . '/app/routes/user/orderHistory.php';
...
require INC_ROOT . '/app/routes/account/language.php';


require INC_ROOT . '/app/routes/menu/createMenu.php';
require INC_ROOT . '/app/routes/menu/createCategory.php';
 ?>
